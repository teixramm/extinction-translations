local my_language = {
	...
	no_entity_vehicle_id = "~r~Il veicolo è desyncato( Bug ).",
...
^2Se vuoi effettuare il prestigio e RITORNARE al livello 0 digita ^1/setprestige^2
	...
	put_item_permission = "Posa oggetti",
	take_item_permission = "Prendi oggetti",
	put_money_permission = "Posa soldi",
	take_money_permission = "Prendi soldi",
	...
	dailymission_sellofferpurchased = "Offerte di vendita acquistate",
	dailymission_sellofferpurchasedbyme = "Offerte di vendita acquistate da",
	dailymission_tradeitems = "Oggetti scambiati",
	dailymission_createbuyoffer = "Offerte di acquisto create",
